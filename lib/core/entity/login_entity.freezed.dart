...
class _$LoginEntityImpl implements _LoginEntity {
  ...
  @override
  String toString() {
    return 'LoginEntity(id: $id, userId: $userId, name: $name, email: $email, token: $token, lastLogin: $lastLogin)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, userId, name, email, token, lastLogin);
